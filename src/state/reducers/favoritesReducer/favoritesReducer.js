...
export default (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case REMOVE_FROM_FAVORITES_SUCCESS:
            return { ...state, favArray: action.payload.favArray, refreshing: false };
        case REMOVE_FROM_FAVORITES_LIST_SUCCESS:
            return { ...state, favList: action.payload.favList, refreshing: false };
        default:
            return { ...state };
    }
};
